package dev.velvet.clickgui.component;
...
public class Frame {
	...
	public Frame(Category cat) {
		...
		for(Module mod : getModulesInCategory(category)) {
	...
	private ArrayList<Module> getModulesInCategory(Category category) {
		ArrayList<Module> mods = new ArrayList<>();
		for (Module mod : ModuleManager.INSTANCE.getModules().values()) {
